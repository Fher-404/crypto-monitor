...
Este proyecto fue generado con [Angular CLI](https://github.com/angular/angular-cli) versión 21.1.0.
...
Esto compilará tu proyecto y almacenará los artefactos de construcción en el directorio `dist/`. Por defecto, la construcción de producción optimiza la aplicación para obtener el mejor rendimiento y velocidad.

## Ejecución de pruebas unitarias

Para ejecutar las pruebas unitarias con el motor de pruebas [Vitest](https://vitest.dev/), utiliza el siguiente comando:
...
Angular CLI no viene con un framework de pruebas e2e por defecto. Puedes elegir el que mejor se adapte a tus necesidades.
